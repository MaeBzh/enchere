                            ...
                            <div class="col-md-6">
                                <div class="media btn btn-default" onclick="location.href='{{ url("objet/$good->id") }}'">
                                    <div class="media-left">
                                        <img class="media-object" src="{{$good->getUrlPhoto()}}" style="width:auto;height:100px">
                                    </div>
                                    <div class="media-body">
                                        ...
                                        <p>Prix actuel : {{ $good->getPrix() }} €
                                            ...
                                            <br>Vendeur : <a href="{{ url("/profil/".$good->vendeur->username) }}" class="btn-link"> {{ ucfirst($good->vendeur->username) }} </a>
                                        </p>
                                    </div>
                                </div>
                            </div>
