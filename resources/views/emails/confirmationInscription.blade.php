...
<head>
    ...
    <title>Projet DevWeb - Site d'enchères</title>
    <style type="text/css">
        #outlook a {
            padding: 0;
        }
        ...
        .ExternalClass, .ExternalClass p, .ExternalClass span, .ExternalClass font, .ExternalClass td, .ExternalClass div, .ExternalClass blockquote {
            line-height: 100%;
        }

        .ExternalClass p, .ExternalClass blockquote {
            margin-bottom: 0;
            margin: 0;
        }
...
<table cellpadding="0" cellspacing="0" border="0" id="backgroundTable"
       style="margin:0; padding:0; width:100% !important; line-height: 100% !important; border-collapse:collapse; mso-table-lspace:0pt; mso-table-rspace:0pt;"
       width="100%">
    <tr>
        <td width="10" valign="top">&nbsp;</td>
        <td valign="top" align="center">
            <table cellpadding="0" cellspacing="0" border="0" align="center"
                   style="width: 100%; max-width: 600px; background-color: #FFF; border-collapse:collapse;mso-table-lspace:0pt;mso-table-rspace:0pt;"
                   id="contentTable">
                <tr>
                        ...
                        <table align='center' border='0' cellpadding='0' cellspacing='0'
                            ...
                            <tr>
                                <td align='left' style='padding: 28px 56px 28px 56px;' valign='top'>
                                    Cordialement,
                                    <br>L'équipe Projet DevWeb - Site d'enchères</td>
                            </tr>
                        </table>
                    </td>
                </tr>
